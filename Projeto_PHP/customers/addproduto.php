...
<form action="addproduto.php" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="produtos['custo']">
    </div>

    <div class="form-group col-md-3">
      <label for="campo2">Valor venda</label>
      <input type="text" class="form-control" name="produtos['venda']">
    </div>

    <div class="form-group col-md-3">
      <label for="campo2">Quantidade em estoque</label>
      <input type="text" class="form-control" name="produtos['estoque']">
    </div>
