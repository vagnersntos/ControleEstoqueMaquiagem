...
<?php foreach ($produto as $produtos) : ?>
	<tr>
		...
		<td class="actions text-right">
			<a href="viewproduto.php?id=<?php echo $produtos['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Visualizar</a>
			<a href="editproduto.php?id=<?php echo $produtos['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
