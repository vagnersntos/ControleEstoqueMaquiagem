...
<form action="editproduto.php?id=<?php echo $produto['id']; ?>" method="post">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" name="produto['custo']" value="<?php echo $produto['custo']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="campo3">Valor venda</label>
      <input type="text" class="form-control" name="produto['venda']" value="<?php echo $produto['venda']; ?>">
    </div>
  </div>
  <div class="row">
    <div class="form-group col-md-5">
      <label for="campo1">Quantidade em Estoque</label>
      <input type="text" class="form-control" name="produto['estoque']" value="<?php echo $produto['estoque']; ?>">
    </div>
